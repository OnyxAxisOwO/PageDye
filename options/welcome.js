...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      privacyContent: 'When you use AI, PageDye sends the page’s colours, layout, hostname and path, plus your prompt and any attached or current background image, to the endpoint you choose. It does not read the page’s text or form contents.',
    ...
    zh: {
      ...
      privacyContent: '使用 AI 时，PageDye 会把页面配色、布局、主机名和路径，以及你的提示词、附件和当前背景图片，发送到你选择的接口。它不会读取网页正文或表单内容。',
