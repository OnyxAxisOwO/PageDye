document.addEventListener('DOMContentLoaded', () => {
  ...
  const messages = {
    en: {
      ...
      presetsTitle: 'Saved themes',
      presetsHint: 'A saved theme keeps the complete look of a website so you can reuse it elsewhere.',
      presetName: 'Theme name', presetNamePlaceholder: 'My theme', presetSource: 'Copy from site',
      savePreset: 'Save theme', builtIn: 'Built-in', custom: 'Custom', deletePreset: 'Delete theme',
      ...
      showGroup: 'Show group', allSites: 'All sites', applyPreset: 'Apply theme', apply: 'Apply',
      ...
      savedPreset: 'Theme saved.', applied: 'Configuration applied to {count} site(s).',
      ...
      confirmDeletePreset: 'Delete theme "{name}"?', delete: 'Delete', presetDeleted: 'Theme deleted.',
    ...
    zh: {
      ...
      presetsTitle: '已保存的主题', presetsHint: '保存一个网站的完整效果，之后可以直接用在其他网站上。',
      presetName: '主题名称', presetNamePlaceholder: '我的主题', presetSource: '复制自站点',
      savePreset: '保存主题', builtIn: '内置', custom: '自定义', deletePreset: '删除主题',
      applySelected: '应用到选中网站', sitesTitle: '同时管理多个网站',
      selectSitesHint: '先选择网站，再选择要进行的操作。', selectedCount: '已选择 {count} 个网站',
      showGroup: '显示分组', allSites: '全部站点', applyPreset: '应用主题', apply: '应用',
      ...
      savedPreset: '主题已保存。', applied: '已应用到 {count} 个站点。',
      ...
      confirmDeletePreset: '删除主题“{name}”？', delete: '删除', presetDeleted: '主题已删除。',
