document.addEventListener('DOMContentLoaded', () => {
  ...
  const messages = {
    en: {
      ...
      typeSite: 'Website', typeRule: 'Page rule', typeDefault: 'Default background', typePreset: 'Theme', typeAppearance: 'Interface', typeOther: 'Other',
    ...
    zh: {
      ...
      typeSite: '网站', typeRule: '页面规则', typeDefault: '默认背景', typePreset: '主题', typeAppearance: '界面外观', typeOther: '其他',
